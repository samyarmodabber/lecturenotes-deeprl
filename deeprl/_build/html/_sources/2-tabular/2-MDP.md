...
Slides: [pdf](https://www.tu-chemnitz.de/informatik/KI/edu/deeprl/lectures/pdf/2.2-MDP.pdf)
...
```{figure} ../img/student-markovchain.png
---
width: 80%
---
...
```{figure} ../img/student-transitionmatrix.png
---
width: 80%
---
...
```{admonition} Why the reward on the long term?

![](../img/return-example.svg)
...
```{figure} ../img/recyclingrobot.png
---
width: 60%
---
Recycling robot. Source: {cite}`Sutton1998`
```
...
```{figure} ../img/backup-V.png
---
width: 80%
---
Backup diagrams of the Bellman equations. Left: the value of a state $s$ depends on the policy $\pi$ and the value of the succeeding states $s'$. Right: the value of an action depends on the value of the action that can be taken in the next states. Source: {cite}`Sutton1998`
```
...
width: 40%
---
Backup diagrams of the Bellman optimality equations. Source: {cite}`Sutton1998`
```
...
```{admonition} Different notations in RL
